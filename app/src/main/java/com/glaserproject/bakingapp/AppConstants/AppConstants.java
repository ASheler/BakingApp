package com.glaserproject.bakingapp.AppConstants;

/**
 * Class created for storing app wide constants and keys
 */
...
public class AppConstants {
    ...
    public static final String IS_TWO_PANE_BUNDLE_KEY = "bundle two pane bool";
